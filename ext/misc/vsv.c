/* Originally from the csv SQLite extension, Public Domain 
** https://www.sqlite.org/csv.html
** 
** modified 2016-05-30 by Alexey Temushkin who also disclaims all copyright
...
#if defined(SQLITE_VSV_STATIC)
#ifdef _WIN32
__declspec(dllexport)
#endif
int sqlite3_vsv_register(
  sqlite3 *db
){
  int rc = SQLITE_OK;  
#ifndef SQLITE_OMIT_VIRTUALTABLE
